...
function fetchProducts() {
    fetch('https://ell887userbackend.azurewebsites.net/api/listProducts') // Assuming this endpoint is configured on your backend server
        .then(response => {
            if (!response.ok) {
...
function fetchFilterOptions() {
    fetch('https://ell887userbackend.azurewebsites.net/api/filterOptions')
        .then(response => {
            if (!response.ok) {
...
function applyFilters() {
    ...
    // Example fetch call:
    fetch('https://ell887userbackend.azurewebsites.net/api/filterProducts', {
        method: 'POST',
        headers: {
